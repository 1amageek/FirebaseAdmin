...
extension QueryPredicate {
    ...
    func makeFilter(collectionID: String) -> Google_Firestore_V1_StructuredQuery.Filter? {
        switch self {
            case .or(let predicates):
                return Google_Firestore_V1_StructuredQuery.Filter.with {
                    $0.compositeFilter = Google_Firestore_V1_StructuredQuery.CompositeFilter.with {
                        $0.op = .or
                        $0.filters = predicates.map({ $0.makeFilter(collectionID: collectionID)! })
                    }
                }
            ...
            case .isEqualToDocumentID(let documentID):
                return Google_Firestore_V1_StructuredQuery.Filter.with {
                    $0.fieldFilter = Google_Firestore_V1_StructuredQuery.FieldFilter.with {
                        ...
                        $0.op = .equal
                        $0.value = documentValue(documentID)
                    }
                }
            ...
            case .isInDocumentID(let documentID):
                return Google_Firestore_V1_StructuredQuery.Filter.with {
                    $0.fieldFilter = Google_Firestore_V1_StructuredQuery.FieldFilter.with {
                        $0.field = Google_Firestore_V1_StructuredQuery.FieldReference.with {
                            $0.fieldPath = "__name__"
            ...
            case .isNotInDocumentID(let documentID):
                return Google_Firestore_V1_StructuredQuery.Filter.with {
                    $0.fieldFilter = Google_Firestore_V1_StructuredQuery.FieldFilter.with {
                        $0.field = Google_Firestore_V1_StructuredQuery.FieldReference.with {
                            $0.fieldPath = "__name__"
            ...
            case .arrayContainsAnyDocumentID(let documentID):
                return Google_Firestore_V1_StructuredQuery.Filter.with {
                    $0.fieldFilter = Google_Firestore_V1_StructuredQuery.FieldFilter.with {
                        $0.field = Google_Firestore_V1_StructuredQuery.FieldReference.with {
                            $0.fieldPath = "__name__"
